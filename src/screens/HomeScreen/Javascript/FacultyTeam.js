...
import { FacultyProfileComponent } from "../Javascript/FacultyProfileComponent.js";

import director from "../../../Images/faculty/director.jpg";
import bhanu from "../../../Images/faculty/bhanu.jpg";
import mprdaf from "../../../Images/faculty/mprdaf.jpg";
import Ap from "../../../Images/faculty/Ap.jpeg";
  ...
  return (
    <div class="container ">
      <section id="team" class="white-bg padding-top-bottom">
        <div class="container ">
          <h1 class="section-title text-center page-title">OUR PATRON</h1>
